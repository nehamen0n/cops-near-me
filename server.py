...
def add_subway_stations(userlat, userlong, radius, locations, currlocationid):
	...
	subway_query = "SELECT P.latitude, P.longitude, S.subway_station_name, S.color_visibility, 'SUBWAY_STATION' AS post_type FROM Post P LEFT JOIN Subway_Station S ON S.subway_station_name = P.location_name WHERE P.post_id IS NULL"
