...
def savelocation():
	...
	post_queries = {
		...
		# 'SUBWAY'
        'Subway': "SELECT P.latitude, P.longitude, P.location_name, P.description, P.date_reported, P.date_resolved, P.post_id, 'SUBWAY' AS post_type, SS.cop_number, NULL AS SS.type_of_cop FROM Post P JOIN Subway_Post SS ON P.post_id = SS.post_id WHERE P.visible = 'Y'"
    }
